...
use Kode\ExpressApi\Bpost\Client;
use Kode\ExpressApi\Bpost\Config;
use Kode\ExpressApi\Common\Exception\ExpressApiException;
use PHPUnit\Framework\TestCase;

class BpostClientTest extends TestCase
{
    ...
    {
        $this->assertSame('https://api.bpost.be', $this->makeConfig()->getBaseUrl());
        $this->assertSame(
            'https://api.bpost.be',
    ...
    public function testPrepareRequestHeadersAddsApiKey(): void
    {
        ...
        $h = $client->headers();
        $this->assertArrayHasKey('X-ApiKey', $h);
        $this->assertSame('test_api_key', $h['X-ApiKey']);
