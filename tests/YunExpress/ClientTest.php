...
use Kode\ExpressApi\YunExpress\Client;
use Kode\ExpressApi\YunExpress\Config;
use PHPUnit\Framework\TestCase;

class YunExpressClientTest extends TestCase
{
    ...
    {
        $this->assertSame('http://oms.api.yunexpress.com', $this->makeConfig()->getBaseUrl());
        $this->assertSame(
