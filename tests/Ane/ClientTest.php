...
use Kode\ExpressApi\Ane\Client;
use Kode\ExpressApi\Ane\Config;
use Kode\ExpressApi\Common\Exception\ExpressApiException;
use Kode\ExpressApi\DomesticFreight\AbstractDomesticFreightClient;
use PHPUnit\Framework\TestCase;

class AneClientTest extends TestCase
{
    ...
    {
        $this->assertSame('https://api.ane56.com/v1', $this->makeConfig()->getBaseUrl());
        $this->assertSame(
            'https://api-test.ane56.com/v1',
