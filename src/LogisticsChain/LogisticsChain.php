...
class LogisticsChain
{
    ...
    private static array $crossBorderByMode = [
        'air' => ['dhl', 'sf_international', 'fourpx', 'yunexpress', 'ems_international', 'yanwen'],
        'sea' => ['fourpx', 'yunexpress', 'ems_international', 'dhl', 'sf_international', 'yanwen'],
    ];

    /** 各环节可按「类目」回退的承运商清单 */
    private static array $categoryFallback = [
        self::LEG_PICKUP      => ['ems', 'sf', 'yunda', 'zto', 'sto', 'cainiao', 'jd'],
        self::LEG_LINEHAUL    => ['debang', 'ane', 'hoau'],
        self::LEG_CROSSBORDER => ['fourpx', 'sf_international', 'dhl', 'yunexpress', 'ems_international', 'yanwen'],
        self::LEG_CUSTOMS     => ['ems_international', 'fourpx', 'yanwen', 'dhl', 'sf_international'],
        self::LEG_LASTMILE    => ['ems', 'sf', 'yunda', 'zto', 'sto', 'cainiao', 'jd',
